      ...
      <DropdownMenuTrigger
        render={
          ...
          >
            ...
            {unreadCount > 0 ? (
              <span className="absolute -top-0.5 -right-0.5 flex size-3.5 items-center justify-center rounded-full border-2 border-background bg-destructive text-[8px] font-semibold text-destructive-foreground">
